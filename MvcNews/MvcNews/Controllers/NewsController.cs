        ...
        public async Task<IActionResult> Edit(int id,  NewsItem newsItem)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateConcurrencyException e)
                {
                    ...
                    {
                        ModelState.AddModelError("", "Cannot save record. It was  modified by different user");
        ...
        public async Task<IActionResult> DeleteConfirmed(int id, NewsItem newsItem)
        {
            ...
            catch (DbUpdateConcurrencyException e)
            {
                ...
                else
                {
                    ...
                    ModelState.AddModelError("", "Cannot save record. It was  modified by another user");
